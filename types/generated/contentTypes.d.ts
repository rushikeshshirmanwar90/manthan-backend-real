...
export interface ApiFlatFlat extends Schema.CollectionType {
  ...
  attributes: {
    ...
    project_type: Attribute.Enumeration<
      ['Ongoing Project', 'Upcoming Project', 'Completed Project']
    > &
      Attribute.Required &
      Attribute.DefaultTo<'Ongoing Project'>;
    ...
    booked: Attribute.BigInteger;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::flat.flat', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::flat.flat', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}
...
export interface ApiLeadLead extends Schema.CollectionType {
  ...
  attributes: {
    ...
    flat_name: Attribute.String;
    assign: Attribute.String;
    flat_id: Attribute.String;
    channel_partner: Attribute.String;
...
export interface ApiProjectProject extends Schema.CollectionType {
  ...
  attributes: {
    ...
    > &
      Attribute.Required;
    ProjectType: Attribute.Enumeration<['onGoing', 'completed', 'upComing']>;
    address: Attribute.String;
    state: Attribute.String;
    city: Attribute.String;
    parkingSpace: Attribute.Boolean &
      Attribute.Required &
      Attribute.DefaultTo<false>;
    swimmingPool: Attribute.Boolean & Attribute.DefaultTo<false>;
    smartHome: Attribute.Boolean & Attribute.DefaultTo<false>;
